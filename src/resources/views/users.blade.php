                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-{{$user->status}} mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('/storage/avatars/{{$user->image}}'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    <a a href="/profile/{{$user->user_id}}" class="fs-xl text-truncate text-truncate-lg text-info" >
                                        {{$user->name}}
                                    </a>
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        @if($admin || $user->user_id === $currentUserId)
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="status/{{$user->user_id}}">
                                            <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                        <a class="dropdown-item" href="/usermedia/{{$user->user_id}}">
